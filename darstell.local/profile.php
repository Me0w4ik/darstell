    ...
    <div class="container-menu">
      <div class="profile">
        <div class="profile-fon1">
          <a href="src/logout.php" class="profile-exit">Выйти</a>
        </div>
        <div class="profile-avatar"></div>
        <div class="profile-fon2">
          <div class="profile-info">
            <p class="profile-nik"><?= $login ?></p>
            <div class="profile-palka"></div>
            <p class="profile-opisanie">Я сделал много разных работ, хотел бы что бы кто то их оценил</p>
          </div>
        </div>
      </div>
      <div class="photo">
        <div class="photo-stolb1">
          <img class="photo0" src = "@">
          <img class="photo0" src = "@">
          <img class="photo0" src = "@">
        </div>
        <div class="photo-stolb2">
          <img class="photo0" src = "@">
          <img class="photo0" src = "@">
          <img class="photo0" src = "@">
          
        </div>
        <div class="photo-stolb3">
          <img class="photo0" src = "@">
          <img class="photo0" src = "@">
          <img class="photo0" src = "@">
        </div>
